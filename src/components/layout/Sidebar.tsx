  ...
  return (
    <aside className="w-64 bg-[#0f0f0f] border-r border-neutral-800/50 flex flex-col h-full shrink-0">
      ...
      <div className="p-4 border-t border-neutral-800/50">
        <button className="w-full flex items-center justify-center gap-2 bg-amber-600 hover:bg-amber-700 text-white px-4 py-2 rounded-lg transition-colors text-sm font-medium shadow-[0_0_15px_-3px_rgba(245,158,11,0.3)] hover:shadow-[0_0_20px_-3px_rgba(245,158,11,0.5)]">
